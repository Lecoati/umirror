...
namespace Lecoati.uMirror
{
    public class ScheduledTaskHandler : IHttpHandler
    {
        ...
        {
            IList<Project> synList = new BllProject().GetAllProjects();
